...
describe('test ethjs-format object', function () {
  describe('test formatQuantity', function () {
    it('should encode normally', function () {
      var bignum = new BN(45333);
      var num = 327243762;
      var stringNumber = '238428237842';
      var noPrefixHexNumber = '21D21A2';
      var prefixHexNumber = '0x21d21a2';
      var nullNumber = null;
      var undefinedNumber = undefined;
      var emptyString = '';
      var zeroNumber = 0;
      var justPrefix = '0';
      var floatNumber = '238428.237842';
    ...
    it('test format object EthSyncing', function () {
    ...
    it('test is required keys are filled, should throw', function () {
      var encodedSendTransactionObject = {
    ...
    it('should decode normally', function () {
      var prefixHexNumber = '0x57840CC2C';
      var noPrefixHexNumber = '21D21A2';
      var largeHexNumber = '0x2386F26FC0FFFF';
      var bignum = new BN(45333);
      var num = 327243762;
      var stringNumber = '238428237842';
      var nullNumber = null;
      ...
      var r1 = format.formatQuantity(prefixHexNumber, false).toString(10);
      var r2 = format.formatQuantity(noPrefixHexNumber, false).toString(10);
      var r3 = format.formatQuantity(largeHexNumber, false).toString(10);
      var r4 = format.formatQuantity(bignum, false).toString(10);
      var r5 = format.formatQuantity(num, false).toString(10);
      var r6 = format.formatQuantity(stringNumber, false).toString(10);
      var r7 = format.formatQuantity(nullNumber, false);
      var r8 = format.formatQuantity(emptyString, false).toString(10);
      var r9 = format.formatQuantity(zeroNumber, false).toString(10);
      var r10 = format.formatQuantity(justPrefix, false).toString(10);
  ...
  describe('test formatQuantityOrTag', function () {
    it('should encode normally', function () {
      var bignum = new BN(45333);
      var num = 327243762;
      var stringNumber = '238428237842';
      ...
      var nullNumber = null;
      var undefinedNumber = undefined;
      var pendingTag = 'pending';
      var latestTag = 'pending';
      var earliestTag = 'earliest';
    ...
    it('should decode normally', function () {
      ...
      var r1 = format.formatQuantityOrTag(prefixHexNumber, false).toString(10);
      var r2 = format.formatQuantityOrTag(noPrefixHexNumber, false).toString(10);
      var r3 = format.formatQuantityOrTag(largeHexNumber, false).toString(10);
      var r4 = format.formatQuantityOrTag(bignum, false).toString(10);
      var r5 = format.formatQuantityOrTag(num, false).toString(10);
      var r6 = format.formatQuantityOrTag(stringNumber, false).toString(10);
      var r7 = format.formatQuantityOrTag(nullNumber, false);
  ...
  describe('test formatObject', function () {
    it('receipt should decode normally', function () {
      var encodedReceiptObject = {
      ...
      var decodedObject = format.formatObject('Receipt', encodedReceiptObject, false);
    ...
    it('transaction object should decode normally', function () {
      var encodedTransactionObject = {
      ...
      var decodedObject = format.formatObject('Transaction', encodedTransactionObject, false);
    ...
    it('should decode Block object normally', function () {
      var encodedTransactionObject = {
        'hash': '0xc6ef2fc5426d6ad6fd9e2a26abeab0aa2411b7ab17f30a99d3cb96aed1d1055b',
        'nonce': '0x',
        'blockHash': '0xbeab0aa2411b7ab17f30a99d3cb9c6ef2fc5426d6ad6fd9e2a26a6aed1d1055b',
      ...
      var decodedObject = format.formatObject('Block', encodedBlockObject, false);
    ...
    it('should encode Filter object normally', function () {
      var decodedFilterObject = {
        fromBlock: 89886779,
        toBlock: 'latest',
      ...
      var encodedObject = format.formatObject('Filter', decodedFilterObject, true);
    ...
    it('should decode send transaction object normally', function () {
      var encodedSendTransactionObject = {
      ...
      var decodedObject = format.formatObject('SendTransaction', encodedSendTransactionObject, false);
    ...
    it('should encode SendTransaction object normally', function () {
      var decodedSendTransactionObject_1 = {
        'from': '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        'to': '0xd46e8dd67c5d32be8058bb8eb970870f07244567',
        'gas': '30400', // 30400,
      ...
      var encodedObject_1 = format.formatObject('SendTransaction', decodedSendTransactionObject_1, true);
      ...
      var decodedSendTransactionObject_2 = {
        'from': '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        'to': '0xd46e8dd67c5d32be8058bb8eb970870f07244567',
      ...
      var encodedObject_2 = format.formatObject('SendTransaction', decodedSendTransactionObject_2, true);
      ...
      var decodedSendTransactionObject_3 = {
        'from': '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        'gas': 30400, // 30400,
        'gasPrice': '10000000000000', // 10000000000000
        'data': '0x'
      ...
      var encodedObject_3 = format.formatObject('SendTransaction', decodedSendTransactionObject_3, true);
      ...
      var decodedSendTransactionObject_4 = {
        'from': '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        'gas': 348978973, // 30400,
        'data': '0x',
        'gasPrice': new BN(10000000000000) };

      var encodedObject_4 = format.formatObject('SendTransaction', decodedSendTransactionObject_4, true);
      ...
      var decodedSendTransactionObject_5 = {
        'from': '0xd46e8dd67c5d32be8058bb8eb970870f07244567',
        'gas': new BN(10000000000000), // 30400,
        'data': '0x',
        'gasPrice': 348978973 };

      var encodedObject_5 = format.formatObject('SendTransaction', decodedSendTransactionObject_5, true);
  ...
  describe('test format', function () {
    it('should encode QUANTITY normally', function () {
      var bignum = new BN(45333);
      var num = 327243762;
      var stringNumber = '238428237842';
      var noPrefixHexNumber = '21D21A2';
    ...
    it('should decode QUANTITY normally', function () {
      var prefixHexNumber = '0x57840CC2C';
      var noPrefixHexNumber = '21D21A2';
      var largeHexNumber = '0x2386F26FC0FFFF';
      var bignum = new BN(45333);
      ...
      var r1 = format.format('Q', prefixHexNumber, false).toString(10);
      var r2 = format.format('Q', noPrefixHexNumber, false).toString(10);
      var r3 = format.format('Q', largeHexNumber, false).toString(10);
      var r4 = format.format('Q', bignum, false).toString(10);
      var r5 = format.format('Q', num, false).toString(10);
      var r6 = format.format('Q', stringNumber, false).toString(10);
      var r7 = format.format('Q', nullNumber, false);
      var r8 = format.format('Q', emptyString, false).toString(10);
      var r9 = format.format('Q', zeroNumber, false).toString(10);

      assert.throws(function () {
        return format.format('Q', '-10', false);
      }, Error);
      assert.equal(r1, '23492348972');
      assert.equal(r2, '35463586');
      assert.equal(r3, '9999999999999999');
    ...
    it('should encode QUANTITY|TAG normally', function () {
      var bignum = new BN(45333);
      var num = 327243762;
      var stringNumber = '238428237842';
      var noPrefixHexNumber = '21D21A2';
    ...
    it('should decode QUANTITY|TAG normally', function () {
      var prefixHexNumber = '0x57840CC2C';
      var noPrefixHexNumber = '21D21A2';
      var largeHexNumber = '0x2386F26FC0FFFF';
      var bignum = new BN(45333);
      ...
      var r1 = format.format('Q|T', prefixHexNumber, false).toString(10);
      var r2 = format.format('Q|T', noPrefixHexNumber, false).toString(10);
      var r3 = format.format('Q|T', largeHexNumber, false).toString(10);
      var r4 = format.format('Q|T', bignum, false).toString(10);
      var r5 = format.format('Q|T', num, false).toString(10);
      var r6 = format.format('Q|T', stringNumber, false).toString(10);
      var r7 = format.format('Q|T', nullNumber, false);
    ...
    it('should decode object SendTransaction object normally', function () {
      var encodedSendTransactionObject = {
        'from': '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        'to': '0xd46e8dd67c5d32be8058bb8eb970870f07244567',
        'gas': '', // 30400,
      ...
      var decodedObject = format.format('SendTransaction', encodedSendTransactionObject, false);
    ...
    it('should encode object SendTransaction object normally', function () {
      var decodedSendTransactionObject_1 = {
        'from': '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        'to': '0xd46e8dd67c5d32be8058bb8eb970870f07244567',
        'gas': new BN('30400'), // 30400,
      ...
      var encodedObject_1 = format.format('SendTransaction', decodedSendTransactionObject_1, true);
    ...
    it('should encode null normally', function () {
      var encodeNull1 = format.format('SendTransaction', null, true);
      var encodeNull2 = format.format('Filter', null, true);
      var encodeNull3 = format.format('D', null, true);
      var encodeNull4 = format.format('B', null, true);
      var encodeNull5 = format.format('S', null, true);
      var encodeNull6 = format.format('Q', null, true);
      var encodeNull7 = format.format('Q|T', null, true);
      var encodeNull8 = format.format('Block', null, true);
      var encodeNull9 = format.format('Array|DATA', null, true);
      var encodeNull10 = format.format(['D'], null, true);
    ...
    it('should handle 20 and 32 byte data properly', function () {
    ...
    it('should decode null normally', function () {
      var decodedNull1 = format.format('SendTransaction', null, false);
      var decodedNull2 = format.format('Filter', null, false);
      var decodedNull3 = format.format('D', null, false);
      var decodedNull4 = format.format('B', null, false);
      var decodedNull5 = format.format('S', null, false);
      var decodedNull6 = format.format('Q', null, false);
      var decodedNull7 = format.format('Q|T', null, false);
      var decodedNull8 = format.format('Block', null, false);
      var decodedNull9 = format.format('Array|DATA', null, false);
      var decodedNull10 = format.format(['D'], null, false);
    ...
    it('should handle arrays normally normally', function () {
  ...
  describe('test formatInputs', function () {
    it('should handle eth_getBalance normally', function () {
      var encodedBalance = format.formatInputs('eth_getBalance', ['0xb60e8dd61c5d32be8058bb8eb970870f07233155']);

      assert.equal(encodedBalance, '0xb60e8dd61c5d32be8058bb8eb970870f07233155');
    });

    it('should handle eth_getBalance 2 arguments normally', function () {
      var encodedBalance = format.formatInputs('eth_getBalance', ['0xb60e8dd61c5d32be8058bb8eb970870f07233155', 'latest']);

      assert.equal(encodedBalance[0], '0xb60e8dd61c5d32be8058bb8eb970870f07233155');
      assert.equal(encodedBalance[1], 'latest');
    });

    it('should handle eth_sendTransaction normally', function () {
      var encodedSendTransaction = format.formatInputs('eth_sendTransaction', [{
        'from': '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        'to': '0xd46e8dd67c5d32be8058bb8eb970870f07244567',
        'gas': new BN('30400'), // 30400,
        'gasPrice': '10000000000000', // 10000000000000
      ...
      var encodedSendTransactionProper = [{
        from: '0xb60e8dd61c5d32be8058bb8eb970870f07233155',
        to: '0xd46e8dd67c5d32be8058bb8eb970870f07244567',
        gas: '0x76c0',
        gasPrice: '0x9184e72a000',
  ...
  describe('test formatOutputs', function () {
    it('should handle invalid eth_getTransactionByBlockHashAndIndex normally', function () {
      try {
        var decodedHashRate = format.formatInputs('eth_getTransactionByBlockHashAndIndex', ['0x']);
      } catch (error) {
        assert.equal(typeof error, 'object');
      }
    });

    it('should handle eth_getFilterChanges normally during eth_newBlockFilter', function () {
      var decodedTxHashArray = format.formatOutputs('eth_getFilterChanges', ['0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55', '0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55']);
    ...
    it('should handle eth_getFilterChanges normally during eth_newPendingTransactionFilter', function () {
      var decodedTxHashArray = format.formatOutputs('eth_getFilterChanges', ['0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55', '0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55']);

      assert.equal(decodedTxHashArray.toString(10), ['0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55', '0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf55']);
    });

    it('should handle eth_hashrate normally', function () {
      var decodedHashRate = format.formatOutputs('eth_hashrate', '0x38a');

      assert.equal(decodedHashRate.toString(10), '906');
    });

    it('should handle eth_getBalance normally', function () {
      var decodedBalance = format.formatOutputs('eth_getBalance', '0x38a');

      assert.equal(decodedBalance.toString(10), '906');
    });

    it('should handle empty eth_hashrate normally', function () {
      var decodedHashRate = format.formatOutputs('eth_hashrate', '0x');

      assert.equal(decodedHashRate.toString(10), '0');
    });

    it('should handle eth_mining true normally', function () {
      var decodedMining = format.formatOutputs('eth_mining', true);

      assert.equal(decodedMining, true);
    });

    it('should handle eth_mining false normally', function () {
      var decodedMining = format.formatOutputs('eth_mining', false);

      assert.equal(decodedMining, false);
    });

    it('should handle eth_accounts normally', function () {
      var decodedEthAccounts = format.formatOutputs('eth_accounts', ['0x407d73d8a49eeb85d32cf465507dd71d507100c1', '0x407d73d8a49eeb85d32cf465507dd71d507100c1', '0x407d73d8a49eeb85d32cf465507dd71d507100c1']);
    ...
    it('should handle empty eth_accounts normally', function () {
      var decodedEthAccounts = format.formatOutputs('eth_accounts', []);

      assert.equal(decodedEthAccounts.length, 0);
    });

    it('should handle eth_getFilterChanges normally', function () {
      var decodedFilterChanges = format.formatOutputs('eth_getFilterChanges', [{
        'logIndex': '0x1', // 1
        'blockNumber': '0x1b4', // 436
